...
As a Veterinary Technician, I've often encountered pet owners who are unsure about the medications their pets are taking. This app provides a convenient solution, ensuring that vital information is always readily available. </p>
           ...
           <a href = "https://github.com/jaalday/Pet--health/tree/master" target = "_blank" rel = "noopener noreferrer"><button className="button1"> View GitHub</button></a>
        </div>
        ...
        <div className="card-4-pet">
            <img className="imgPet" src="https://i.postimg.cc/Gm4WfWv1/Screen-Shot-2024-06-05-at-2-22-32-PM.png"/>
        ...
        <div className="card-7-pet"><img className="imgPet" src="https://i.postimg.cc/T201DV4F/Screen-Shot-2024-06-05-at-2-16-46-PM.png"/></div>
